...
export class Plugin extends AbstractPlugin {
  ...
  public getPluginSpecificCommands(): BotCommand[] {
    ...
    const crime1Command = new BotCommand([Commands.crime1, Commands.crime2, Commands.crime3], "", this.hustle.bind(this), false);
    ...
    return [lifeCommand, statusCommand, workCommand, crime1Command, breakoutCommand, officeCommand, prisonCommand, bribeCommand, togglelifetagsCommand,
